...
public class TestExercise4 extends ExerciseTest {
   ...
   * <p>
   * You will notice that the {@link WeeklyRentalContractMaker#createStandardContract(String, int)}
  ...
  public void testUsingTheEnum() {
    WeeklyRentalContract mattsContract = new WeeklyRentalContractMaker().createStandardContract("Matt", 1000);
    ...
    WeeklyRentalContract tonysContract = new WeeklyRentalContractMaker().createStandardContract("Tony", 1200);
   ...
   * BONUS CONTENT 1
   *
   *  Now that we know what enums are, there is a class in the dependencies package which looks
   *  suspiciously like it could/should be converted into an enum... can you figure out which one,
   *  and convert it?
   */
