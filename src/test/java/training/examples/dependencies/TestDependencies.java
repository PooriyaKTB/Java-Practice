...
public class TestDependencies extends ExerciseTest {
  ...
  /**
   * Have a look at all the types within the dependencies package.
   ...
   * 2. Write the FuelType class as described in the file. Make sure you include a way of accessing the property mentioned.
   ...
   * 5. Use your custom engine in the {@link DependenciesApp}. Use a fuel type with the name PETROL for the engine.
   */
  @Test
